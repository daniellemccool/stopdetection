...
#'
#' Real data from November 2019 extracted from Google Location History files
#' captured with an Android smartphone. Contains two weeks of human movement
#' behavior of a single person occurring in the Netherlands.
#'
#' @docType data
#' @name loc_data_2019
#' @format A data frame with 21,911 rows and 3 columns:
#' \describe{
