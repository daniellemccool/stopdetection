...
testthat::test_that("stopMerger creates new_stop_id correctly", {
  testthat::expect_equal(stopMerger(copy(testevents), 200)$new_stop_id, c(1, 2, 3, 4, 4, 4, 5))
  testthat::expect_equal(stopMerger(copy(testevents), 3)$new_stop_id, c(1, 2, 3, 4, 5, 5, 6))
  testthat::expect_equal(stopMerger(copy(te2), 200)$new_stop_id, c(1, 2, 3, 4, 4, 4, 5, 6, 7, 8, 9, 9, 9, 10))
})
